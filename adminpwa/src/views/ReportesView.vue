  ...
  <AdminLayout>
    ...
    <div class="page-header">
      <div class="page-header__left">
        ...
        <div>
          <h1 class="page-header__title">Reportes Jitomate</h1>
          <p class="page-header__sub">{{ reportes.length }} registro{{ reportes.length !== 1 ? 's' : '' }} encontrado{{ reportes.length !== 1 ? 's' : '' }}</p>
        </div>
      </div>
